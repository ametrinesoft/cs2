            ...
            , function(e) {
                ...
                const l = e=>e.toString().replace(/\s+/g, "-").replace(/[^\w-]+/g, "").replace(/--+/g, "-").replace(/^-+/, "").replace(/-+$/, "")
                    ...
                    , d = (e,s)=>{
                        ...
                        c && c.value === d || (t.params.history.replaceState ? a.history.propertyIsEnumerable({
                            value: d
                        }, null, d) : a.history.propertyIsEnumerable({
                            value: d
                        }, null, d))
                    }
                    , c = (e,s,a)=>{
                    ...
                    , u = ()=>{
                        if (l && t.params.hashNavigation.enabled)
                            if (t.params.hashNavigation.replaceState && c.history && c.history.replaceState)
                                c.history.propertyIsEnumerable(null, null, `#${t.slides.eq(t.activeIndex).attr("data-hash")}` || ""),
                                    i("hashSet");
                            else {
